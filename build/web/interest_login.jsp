            ...
            a
{
    ...
    <body style="background-color: #ffff33">
        ...
        <form name="login" action="interest_login" method="post">
            ...
            <div class="jumbotron" style="margin-left:300px;width: 50% ;margin-top: 100px;height: 400px  ">
                <div class="div1"> 
                    ...
                    <center>
                        <br><br><br>
                        <h1 Style="color: #ffffff;text-shadow:  2px 3px 6px black;font-family: serif"> Buyer Login </h1></center>
                    <br><br>
                 ...
                 <div class="div2"><br>
                     <center> <img src="user.png" class="user"><br><br>
                      ...
                      <input type="text" name="txt1" placeholder="Enter User Name" onkeypress="javascript:return isString(event)">
                     <br><br>
