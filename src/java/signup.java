    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       ...
       String event=req.getParameter("btn1");
        ...
        if(event.equals("SignUp"))
        {
            ...
            {
         String insert=db.Insert("insert into user_mst(uid,fname,lname,gender,DOB,address,contact_no,email,username,pass_word)values('"+uid.toString()+"','"+fname.toString()+"','"+lname.toString()+"','"+gender.toString()+"','"+date.toString()+"','"+address.toString()+"','"+contact.toString()+"','"+mail.toString()+"','"+uname.toString()+"','"+enterpass.toString()+"')");
         out.println(insert);
      ...
      if(event.equals("Delete"))
            {
            String Delete=db.Delete("delete from user_mst where uid='"+uid.toString()+"'");
